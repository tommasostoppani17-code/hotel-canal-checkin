...
export function emailBodyStyle({ size = '14.5px', line = '1.55' } = {}) {
...
export function emailLabelStyle({ size = '10px', color = '#8A949C' } = {}) {
...
export function emailSectionStyle({ size = '13px', color = '#164E5B' } = {}) {
...
export function emailValueStyle({ size = '16px', color = '#164E5B' } = {}) {
...
/** CTA bottone. */
export function emailCtaStyle({ size = '12.5px' } = {}) {
