...
export const WELCOME_I18N = {
  it: {
    ...
    preheader: (room) =>
      `Camera ${room || 'da assegnare'} · Wi-Fi · Codici porta · Voucher 5%`,
    preheaderNoCoupon: 'Wi-Fi · Codici porta · Guida Venezia · Coupon ristorante su richiesta',
    claimTitle: 'Sconto ristorante 5%',
    claimDesc:
    ...
    textVoucher:
      'Voucher sconto 5%: mostra il QR di questa email al cameriere.',
  ...
  en: {
    ...
    preheader: (room) =>
      `Room ${room || 'to be assigned'} · Wi-Fi · Door codes · 5% voucher`,
    preheaderNoCoupon: 'Wi-Fi · Door codes · Venice guide · Restaurant coupon on request',
    claimTitle: '5% restaurant discount',
    claimDesc:
    ...
    textVoucher:
      '5% discount voucher: show the QR in this email to your waiter.',
  ...
  fr: {
    ...
    preheader: (room) =>
      `Chambre ${room || 'à assigner'} · Wi-Fi · Codes porte · Bon 5%`,
    preheaderNoCoupon: 'Wi-Fi · Codes porte · Guide Venise · Bon resto sur demande',
    claimTitle: 'Réduction restaurant 5%',
    claimDesc:
  ...
  de: {
    ...
    preheader: (room) =>
      `Zimmer ${room || 'noch zuzuweisen'} · Wi-Fi · Türcodes · 5%-Gutschein`,
    preheaderNoCoupon: 'Wi-Fi · Türcodes · Venedig-Guide · Restaurantgutschein auf Anfrage',
    claimTitle: '5% Restaurant-Rabatt',
    claimDesc:
    ...
    privilegeTitle: 'Willkommensprivileg',
    ...
    voucherTitle: '5% RABATTGUTSCHEIN',
    ...
    textVoucher:
      '5%-Gutschein: zeigen Sie den QR in dieser E-Mail dem Kellner.',
  ...
  es: {
    ...
    preheader: (room) =>
      `Habitación ${room || 'por asignar'} · Wi-Fi · Códigos puerta · Cupón 5%`,
    preheaderNoCoupon: 'Wi-Fi · Códigos puerta · Guía Venecia · Cupón restaurante bajo petición',
    claimTitle: 'Descuento restaurante 5%',
    claimDesc:
    ...
    textVoucher:
      'Cupón 5%: muestre el QR de este correo al camarero.',
